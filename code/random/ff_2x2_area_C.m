%-----------------------------------------------------------------------
% Job saved on 21-May-2014 22:53:56 by cfg_util (rev $Rev: 5797 $)
% spm SPM - SPM12b (5918)
% cfg_basicio BasicIO - Unknown
%-----------------------------------------------------------------------
matlabbatch{1}.cfg_basicio.file_dir.dir_ops.cfg_mkdir.parent = {'/Volumes/crunch/freshTPS/random/C'};
...
matlabbatch{2}.spm.stats.factorial_design.des.fd.icell(1).scans = {
                                                                   ...
                                                                   '/Volumes/crunch/freshTPS/betas/fx_2/area/tps18_win.img,1'
                                                                   '/Volumes/crunch/freshTPS/betas/fx_2/area/tps21_win.img,1'
                                                                   '/Volumes/crunch/freshTPS/betas/fx_2/area/tps22_win.img,1'
                                                                   '/Volumes/crunch/freshTPS/betas/fx_2/area/tps25_win.img,1'
...
matlabbatch{2}.spm.stats.factorial_design.des.fd.icell(2).scans = {
                                                                   ...
                                                                   '/Volumes/crunch/freshTPS/betas/fx_2/area/tps18_lose.img,1'
                                                                   '/Volumes/crunch/freshTPS/betas/fx_2/area/tps21_lose.img,1'
                                                                   '/Volumes/crunch/freshTPS/betas/fx_2/area/tps22_lose.img,1'
                                                                   '/Volumes/crunch/freshTPS/betas/fx_2/area/tps25_lose.img,1'
...
matlabbatch{2}.spm.stats.factorial_design.des.fd.icell(3).scans = {
                                                                   ...
                                                                   '/Volumes/crunch/freshTPS/betas/fx_2/area/tps15_win.img,1'
...
matlabbatch{2}.spm.stats.factorial_design.des.fd.icell(4).scans = {
                                                                   ...
                                                                   '/Volumes/crunch/freshTPS/betas/fx_2/area/tps15_lose.img,1'
